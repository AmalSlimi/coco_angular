...
export class CategoryService {
  ...
  api="http://localhost:8085/spring2024/collocation";
  host="http://localhost:8085/spring2024/collocation/getPhotoAccommodation/";

  host2="http://localhost:8085/spring2024/collocation/getPhotoRoom/";
