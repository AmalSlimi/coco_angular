            ...
            <div class="layout-topbar-wrapper">
                <div class="layout-topbar-left">
                    <div class="layout-topbar-logo" id="logolink" style="cursor: pointer; outline: none;" routerLink="/">
                        <img id="app-logo"
                             [src]="'assets/backOffice/layout/images/logo-' + (app.topbarTheme === 'light' ? 'coco' : 'coco-dark') + '.png'"
                             alt="coco-layout">
                    </div>
                </div>
                    ...
                    <ul class="layout-topbar-actions">
                        ...
                        <li #messages class="topbar-item messages" [ngClass]="{'active-topmenuitem':appMain.activeTopbarItem === messages}">
                            ...
                            <ul class="fadeInDown">
                                ...
                                <li role="menuitem">
                                    <a href="#" (click)="appMain.onTopbarSubItemClick($event)">
                                        <img src="assets/backOffice/layout/images/dashboard/leader-1.png" alt="demo">
                                ...
                                <li role="menuitem">
                                    <a href="#" (click)="appMain.onTopbarSubItemClick($event)">
                                        <img src="assets/backOffice/layout/images/dashboard/leader-2.png" alt="demo">
                                        <div class="messages-item">
                                ...
                                <li role="menuitem">
                                    <a href="#" class="topbar-message" (click)="appMain.onTopbarSubItemClick($event)">
                                        <img src="assets/backOffice/layout/images/dashboard/leader-3.png" alt="demo">
                                        <div class="messages-item">
                                ...
                                <li role="menuitem">
                                    <a href="#" class="topbar-message" (click)="appMain.onTopbarSubItemClick($event)">
                                        <img src="assets/backOffice/layout/images/dashboard/leader-4.png" alt="demo">
                                        <div class="messages-item">
                        ...
                        <li #profile class="topbar-item user-profile"
                            ...
                            <a href="#" (click)="appMain.onTopbarItemClick($event,profile)">
                                <img class="profile-image" src="assets/backOffice/layout/images/avatar-profile.png" alt="demo">
