...
export class AppConfigComponent implements OnInit, OnDestroy {
    ...
    onLayoutModeChange(event) {
        ...
        const layoutHref = 'assets/backOffice/layout/css/layout-' + this.app.layoutMode + '.css';
    ...
    changeTheme(theme) {
        ...
        const themeHref = 'assets/backOffice/theme/' + theme + '/theme-' + this.app.layoutMode + '.css';
