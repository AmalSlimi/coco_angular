...
import { AppBreadcrumbService } from 'src/app/backOffice/app.breadcrumb.service';
@Component({
...
export class BlocksComponent{
  ...
  <div class="grid grid-nogutter surface-section text-800">
      ...
      <div class="col-12 md:col-6 overflow-hidden">
          <img src="assets/backOffice/demo/images/blocks/hero/hero-1.png" alt="Image" class="md:ml-auto block md:h-full" style="clip-path: polygon(8% 0, 100% 0%, 100% 100%, 0 100%)">
      </div>
  </div>`;
  ...
  <div class="surface-card p-4 shadow-2 border-round w-full lg:w-6">
      <div class="text-center mb-5">
          <img src="assets/backOffice/demo/images/blocks/logos/hyper.svg" alt="Image" height="50" class="mb-3">
